export default function Register() {
    return (
        <div className="h-screen flex flex-col-reverse md:flex-row">
            <div className="h-1/2md:w-1/2 flex justify-center items-center  py-48 p-12">
                <div className="">
                ...
                <div className="pt-12">
                    <input
                        placeholder="Email" id="email" type="email" autoComplete="email"
                ...
                <div className="pt-4">
                    <input
                        id="password" type="password" autoComplete="password" placeholder="Password"
                        className="appearance-none shadow-sm block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 sm:text-sm focus:z-10 focus:outline-none focus:border-indigo-500 focus:ring-indigo-500"
                    />
                </div>
